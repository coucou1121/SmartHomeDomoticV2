...
*/
#define IOCON_7_BANK        0
#define IOCON_6_MIRROR		0
#define IOCON_5_SEQOP		0
#define IOCON_4_IPOLB		0
#define IOCON_3_HAEN        0
#define IOCON_2_ODR         0
#define IOCON_1_INTPOL		0
...
typedef struct
{
    ...
    quint8 IODIR_reg;       /*! Device IODIR register */
    quint8 IPOL_reg;        /*! Device IPO register */
    quint8 GPINT_reg;       /*! Device GPINT register */
    quint8 DEFVAL_reg;      /*! Device DEFVAL register */
    quint8 INTCON_reg;      /*! Device INTCON register */
...
public:
    MCP23017();
    MCP23017(quint8 device_I2C_Adress = MCP23017_ADDRESS_DEFAULT_20);
...
#ifdef MCP23017_INTERRUPT_SUPPORT
    ...
    smcp23017_IOCON sIOCON() const;
    void setSIOCON(const smcp23017_IOCON &sIOCON);
