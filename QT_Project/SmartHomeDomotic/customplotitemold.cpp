...
void CustomPlotItem::replot(bool resize)
{
    ...
    if(resize)
    {
        ...
        this->_customPlot->xAxis->rescale(true);
        //        this->_customPlot->yAxis->rescale(true);
        //        this->_customPlot->axisRect(0)->axis(QCPAxis::atLeft)->rescale(true);
    }

    //    if(this->_myPlotStyle ==GlobalEnumerate::PLOT_STYLE_LIVE_TANKS_TRACE)
    //    {
    //        this->_graph0->valueAxis()->setRange(this->_yValueMax-10, this->_yValueMax);
    //        this->_graph1->valueAxis()->setRange(this->_yValueMax-10, this->_yValueMax);
    //        this->_graph2->valueAxis()->setRange(this->_yValueMax-10, this->_yValueMax);
    //        this->_graph3->valueAxis()->setRange(this->_yValueMax-10, this->_yValueMax);
    //        this->_graph4->valueAxis()->setRange(this->_yValueMax-10, this->_yValueMax);
    //        this->_graph5->valueAxis()->setRange(this->_yValueMax-10, this->_yValueMax);
    //        this->_customPlot->yAxis->setRange(90, 110);
    //        this->_customPlot->yAxis->rescale(true);
    //        qDebug() << Q_FUNC_INFO << "nb yaxis: " << this->_customPlot->axisRectCount();
    //    }
                               ...
                               bool tickAsDate, quint64 tickNumber, bool isTheFirstData)
{
    ...
    for (int i = 1; i<=this->_nbOfTrace; i++)
    {
        ...
        case 1:
            ...
            break;
        case 2:
            if(!this->_graph1->visible() && !this->_arrayPlotContainerPointerGraph1->isEmpty())
            {
                _arrayPlotContainerPointerGraph1->clear();
                this->_graph1->data().data()->clear();
//                this->_customPlot->removeGraph(this->_graph1);
//                this->_graph1 = nullptr;
            }
            if(this->_graph1->visible())
            {
//                if(this->_graph1 == nullptr)
//                {
...
//                }
            ...
            break;
        case 3:
            if(!this->_graph2->visible() && !this->_arrayPlotContainerPointerGraph2->isEmpty())
            {
                _arrayPlotContainerPointerGraph2->clear();
                this->_graph2->data().data()->clear();
//                this->_customPlot->removeGraph(this->_graph2);
//                this->_graph2 = nullptr;
            }
            if(this->_graph2->visible())
            {
//                if(this->_graph2 == nullptr)
//                {
//                    this->createGraphInPlot();
//                }
            ...
            break;
        case 4:
            if(!this->_graph3->visible() && !this->_arrayPlotContainerPointerGraph3->isEmpty())
            {
                _arrayPlotContainerPointerGraph3->clear();
                this->_graph3->data().data()->clear();
//                this->_customPlot->removeGraph(this->_graph3);
//                this->_graph3 = nullptr;
            }
            if(this->_graph3->visible())
            {
//                {
//                    this->createGraphInPlot();
//                }
            ...
            break;
        case 5:
            if(!this->_graph4->visible() && !this->_arrayPlotContainerPointerGraph4->isEmpty())
            {
                _arrayPlotContainerPointerGraph4->clear();
                this->_graph4->data().data()->clear();
//                this->_customPlot->removeGraph(this->_graph4);
//                this->_graph4 = nullptr;
            }
            if(this->_graph4->visible())
            {
//                if(this->_graph4 == nullptr)
//                {
//                    this->createGraphInPlot();
//                }
            ...
            break;
        case 6:
            if(!this->_graph5->visible() && !this->_arrayPlotContainerPointerGraph5->isEmpty())
            {
                _arrayPlotContainerPointerGraph5->clear();
                this->_graph5->data().data()->clear();
//                this->_customPlot->removeGraph(this->_graph5);
//                this->_graph5 = nullptr;
            }
            if(this->_graph5->visible())
            {
//                if(this->_graph5 == nullptr)
//                {
//                    this->createGraphInPlot();
