...
HomeViewerForm
{
    ...
    function setAllTitleText(homeViewerDevice, titleText)
    {
        ...
        case E_HomePageObject.HOMEAD1115_2:
            ...
            break;
        case E_HomePageObject.HOMEAMCP23017_1:
            textMCP23017_1Text = titleText;
            break;
        case E_HomePageObject.HOMEAMCP23017_2:
            textMCP23017_2Text = titleText;
            break;
        case E_HomePageObject.HOMEAMCP23017_3:
            textMCP23017_3Text = titleText;
            break;
        case E_HomePageObject.HOMEAMCP23017_4:
            textMCP23017_4Text = titleText;
            break;
        default :
            break;
        }
...
//        console.log("Array size " + textLenghtArray.length + ", first element : " + textLenghtArray[0])
    ...
    function changeColorMCP23017_1(color)
    {
        rectangleMCP23017_1Color = color;
    }

    function changeColorMCP23017_2(color)
    {
        rectangleMCP23017_2Color = color;
    }

    function changeColorMCP23017_3(color)
    {
        rectangleMCP23017_3Color = color;
    }

    function changeColorMCP23017_4(color)
    {
        rectangleMCP23017_4Color = color;
    }
