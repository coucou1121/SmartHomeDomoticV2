...
void DataAnalyser::savePlotData(DataFrame *dataFrame)
{
    ...
    {
        this->_filePlotsDataReadOnly.setPermissions(GlobaleStaticValue::filePermissions);
    ...
    {
        this->_filePlotsDataWriteOnly.setPermissions(GlobaleStaticValue::filePermissions);
...
void DataAnalyser::run()
{
    ...
    while(true)
    {
        ...
        if(this->_dataFrame->ADS115_1_chan0() > 0)
        {
            ...
            offsetLiquidePressure = this->_offsetVolumePressure((this->_dataFrame->BME280_pressure() - memoStartPressure),
        ...
        if (memoSecond != this->_dataFrame->dateTime().time().second())
        {
            ...
            qDebug() << Q_FUNC_INFO << "memoStartPressure: " << memoStartPressure << "offsetLiquidePressure: " << offsetLiquidePressure
