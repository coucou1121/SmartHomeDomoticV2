...
#include "../SmartHomeDomotic/BME280/bme280item.h"
...
QT_MOC_LITERAL(1, 11, 15), // "jumpToNextState"
QT_MOC_LITERAL(2, 27, 0) // ""

    },
    "BME280Item\0jumpToNextState\0"
};
...
void BME280Item::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->jumpToNextState(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&BME280Item::jumpToNextState)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject BME280Item::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_BME280Item.data,
...
// SIGNAL 0
void BME280Item::jumpToNextState()
{
