...
void MCP2317item::_initDevice()
{
    ...
    {
        qDebug() << Q_FUNC_INFO << "All as input";
        this->_pmcp23017Device->IODIR_reg = GPIO_ALL_INPUT;
        QMetaObject::invokeMethod(this->_MCP23017Viewer, "setAllInpout",
                                  Q_ARG(QVariant, 0xAAAA)
                                  );
...
bool MCP2317item::_checkRegisterConfiguration()
{
    ...
    registerValue = this->_mcp23017->readRegister(MCP23017_ADDRESS_IODIRA) << 8;
    registerValue |= this->_mcp23017->readRegister(MCP23017_ADDRESS_IODIRB);
    ...
    registerValue = this->_mcp23017->readRegister(MCP23017_ADDRESS_IPOLA) << 8;
    registerValue |= this->_mcp23017->readRegister(MCP23017_ADDRESS_IPOLB);
    qDebug() << Q_FUNC_INFO << this->_pmcp23017Device->device_id << "registerValue IPOL : " << QString::number(registerValue,2) << "register ok : " << registerOK;

    registerValue = this->_mcp23017->readRegister(MCP23017_ADDRESS_GPINTENA) << 8;
    registerValue |= this->_mcp23017->readRegister(MCP23017_ADDRESS_GPINTENB);
    qDebug() << Q_FUNC_INFO << this->_pmcp23017Device->device_id << "registerValue GPINTEN : " << QString::number(registerValue,2) << "register ok : " << registerOK;

    registerValue = this->_mcp23017->readRegister(MCP23017_ADDRESS_DEFVALA) << 8;
    registerValue |= this->_mcp23017->readRegister(MCP23017_ADDRESS_DEFVALA);
    qDebug() << Q_FUNC_INFO << this->_pmcp23017Device->device_id << "registerValue DEFVAL : " << QString::number(registerValue,2) << "register ok : " << registerOK;

    registerValue = this->_mcp23017->readRegister(MCP23017_ADDRESS_INTCONA) << 8;
    registerValue |= this->_mcp23017->readRegister(MCP23017_ADDRESS_INTCONB);
    qDebug() << Q_FUNC_INFO << this->_pmcp23017Device->device_id << "registerValue INTCON : " << QString::number(registerValue,2) << "register ok : " << registerOK;
    ...
    registerValue = this->_mcp23017->readRegister(MCP23017_ADDRESS_GPPUA) << 8;
    registerValue |= this->_mcp23017->readRegister(MCP23017_ADDRESS_GPPUA);
    qDebug() << Q_FUNC_INFO << this->_pmcp23017Device->device_id << "registerValue GPPU : " << QString::number(registerValue,2) << "register ok : " << registerOK;

    registerValue = this->_mcp23017->readRegister(MCP23017_ADDRESS_INTFA) << 8;
    registerValue |= this->_mcp23017->readRegister(MCP23017_ADDRESS_INTFB);
    qDebug() << Q_FUNC_INFO << this->_pmcp23017Device->device_id << "registerValue INTF : " << QString::number(registerValue,2) << "register ok : " << registerOK;

    registerValue = this->_mcp23017->readRegister(MCP23017_ADDRESS_INTCAPA) << 8;
    registerValue |= this->_mcp23017->readRegister(MCP23017_ADDRESS_INTCAPA);
    qDebug() << Q_FUNC_INFO << this->_pmcp23017Device->device_id << "registerValue INTCAP : " << QString::number(registerValue,2) << "register ok : " << registerOK;

    registerValue = this->_mcp23017->readRegister(MCP23017_ADDRESS_GPIOA) << 8;
    registerValue |= this->_mcp23017->readRegister(MCP23017_ADDRESS_GPIOB);
    qDebug() << Q_FUNC_INFO << this->_pmcp23017Device->device_id << "registerValue GPIO : " << QString::number(registerValue,2) << "register ok : " << registerOK;

    registerValue = this->_mcp23017->readRegister(MCP23017_ADDRESS_OLATA) << 8;
    registerValue |= this->_mcp23017->readRegister(MCP23017_ADDRESS_OLATB);
    qDebug() << Q_FUNC_INFO << this->_pmcp23017Device->device_id << "registerValue OLAT : " << QString::number(registerValue,2) << "register ok : " << registerOK;
