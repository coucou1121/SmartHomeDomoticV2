...
int main(int argc, char *argv[])
{
    ...
    //create link bettween C++ and QML with the
    ...
    QObject *qcustomPlotStatisticHumidity = nullptr;
    ...
    if (!engine.rootObjects().isEmpty())
    {
        ...
        qcustomPlotStatisticHumidity = engine.rootObjects().first()->findChild<QObject*>("qcustomPlotStatisticHumidity");
    ...
    //data manager thread
    DataAnalyser *dataAnalyserObject = new DataAnalyser(100,
                                                        qobjectStastisticValueViewer,
                                                        qobjectStatisticViewer);
    qDebug() << "dataAnalyserObject created";
    ...
    //CPP object creation from existing hardware device
