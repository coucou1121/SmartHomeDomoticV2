...
void Setting::receivedGraphReccordTimesChanged(const int reccordTime)
{
    ...
    qDebug() << Q_FUNC_INFO << "graphicRange" << graphicRange << ", refreshTime"
...
//    this->initTankObjectName(this->_Tank6->objectID(),this->_Tank6->objectName());
    ...
    QMetaObject::invokeMethod(this->_settingViewer, "setVolumePIDCoef",
                              Q_ARG(QVariant, this->_ads1115_1->PIDVolumeCoef())
                              );
...
void Setting::saveSettings()
{
    ...
    this->_setting->setValue(GlobaleStaticValue::ADS1115_Volume_PID_coef, this->_ads1115_1->PIDVolumeCoef());
...
void Setting::loadSettings()
{
    ...
    QString ADS1115_Volume_PID_coef = groupeNameSetting + "/" + GlobaleStaticValue::ADS1115_Volume_PID_coef;
    ...
    this->_ads1115_1->setPIDVolumeCoef(this->_setting->value(ADS1115_Volume_PID_coef,1).toInt());
