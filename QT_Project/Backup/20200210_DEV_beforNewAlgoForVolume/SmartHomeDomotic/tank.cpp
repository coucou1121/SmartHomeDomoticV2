...
int Tank::volumeMaxHeightInMilimeter() const
{
    return _volumeMaxHeightInMilimeter;
}

void Tank::setVolumeMaxHeightInMilimeter(int volumeMaxHeightInMilimeter)
{
    _volumeMaxHeightInMilimeter = volumeMaxHeightInMilimeter;
}
