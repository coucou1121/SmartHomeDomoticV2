...
QMap<int, QString> GlobaleStaticValue::initHomeViewObject()
{
    ...
    ret.insert(GlobalEnumerate::HOMEAMCP23017_1, MCP23017_1Name);
    ret.insert(GlobalEnumerate::HOMEAMCP23017_2, MCP23017_2Name);
    ret.insert(GlobalEnumerate::HOMEAMCP23017_3, MCP23017_3Name);
    ret.insert(GlobalEnumerate::HOMEAMCP23017_4, MCP23017_4Name);
    return ret;
}
