...
//        console.log("setGraphicReccordTime ID: " + reccordTime)
    ...
    function setMCP23017RegIODIR(MCP23017ID, value, valueTxt)
    {
        ...
        case E_MCP23017ObjectID.MCP23017_1:
            mCP23017_1.setRegIODIR(value, valueTxt)
            break;
        case E_MCP23017ObjectID.MCP23017_2:
            mCP23017_2.setRegIODIR(value, valueTxt)
            break;
        case E_MCP23017ObjectID.MCP23017_3:
            mCP23017_3.setRegIODIR(value, valueTxt)
            break;
        case E_MCP23017ObjectID.MCP23017_4:
            mCP23017_4.setRegIODIR(value, valueTxt)
            break;
        default:
            break;
        }
