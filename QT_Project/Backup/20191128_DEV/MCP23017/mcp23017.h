...
public:
     ...
     * See "3.5.1 I/O Direction register".
     */
    void gpioPinModeDirection(quint8 pin, bool direction);
     ...
     */
    quint8 readRegister(quint8 registerName);
...
private:
    ...
    quint16 _convertIOCONStructToRegValue(pmcp23017_IOCON pIOCON);
};
