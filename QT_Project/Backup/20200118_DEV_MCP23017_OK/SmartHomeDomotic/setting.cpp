...
Setting::Setting(QObject *parent,
                 ...
                 MCP2317item *mcp23017_1,
                 MCP2317item *mcp23017_2,
                 MCP2317item *mcp23017_3,
                 MCP2317item *mcp23017_4,
    ...
    _mcp23017_1(mcp23017_1),
    _mcp23017_2(mcp23017_2),
    _mcp23017_3(mcp23017_3),
    _mcp23017_4(mcp23017_4),
...
void Setting::ReceivedIODIRregChanged(const int deviceID, const int regIODIRvalue)
{
    qDebug() << Q_FUNC_INFO << "ReceiveIODIRregChanged, ID: " << deviceID
             << ", " << QString::number(regIODIRvalue,2)
             << " ," << (int)GlobalEnumerate::HOMEMCP23017_1;

            switch(deviceID)
            {
            case GlobalEnumerate::HOMEMCP23017_1:
                this->_mcp23017_1->setIODIRreg(regIODIRvalue);
                break;
            case GlobalEnumerate::HOMEMCP23017_2:
                this->_mcp23017_2->setIODIRreg(regIODIRvalue);
                break;
            case GlobalEnumerate::HOMEMCP23017_3:
                this->_mcp23017_3->setIODIRreg(regIODIRvalue);
                break;
            case GlobalEnumerate::HOMEMCP23017_4:
                this->_mcp23017_4->setIODIRreg(regIODIRvalue);
                break;
            default:
                break;
            }
...
void Setting::ReceivedGPIOregChanged(const int deviceID, const int regGPIOvalue)
{
    qDebug() << Q_FUNC_INFO << "ReceivedGPIOregChanged, ID: " << deviceID
             << ", " << QString::number(regGPIOvalue,2);

            switch(deviceID)
            {
            case GlobalEnumerate::HOMEMCP23017_1:
                this->_mcp23017_1->setGPIOreg(regGPIOvalue);
                break;
            case GlobalEnumerate::HOMEMCP23017_2:
                this->_mcp23017_2->setGPIOreg(regGPIOvalue);
                break;
            case GlobalEnumerate::HOMEMCP23017_3:
                this->_mcp23017_3->setGPIOreg(regGPIOvalue);
                break;
            case GlobalEnumerate::HOMEMCP23017_4:
                this->_mcp23017_4->setGPIOreg(regGPIOvalue);
                break;
            default:
                break;
            }
...
//    this->_initTankOffsetPressure(this->_Tank6->objectID(),this->_ads1115_2->offsetPressurChan1());
    ...
    this->_initHomeViewObject(GlobalEnumerate::HOMEMCP23017_1, _homeViewObject[GlobalEnumerate::HOMEMCP23017_1]);
    this->_initHomeViewObject(GlobalEnumerate::HOMEMCP23017_2, _homeViewObject[GlobalEnumerate::HOMEMCP23017_2]);
    this->_initHomeViewObject(GlobalEnumerate::HOMEMCP23017_3, _homeViewObject[GlobalEnumerate::HOMEMCP23017_3]);
    this->_initHomeViewObject(GlobalEnumerate::HOMEMCP23017_4, _homeViewObject[GlobalEnumerate::HOMEMCP23017_4]);
...
void Setting::_initMCP23017()
{
    ...
    QMetaObject::invokeMethod(this->_settingViewer, "setMCP23017RegIODIR",
                              Q_ARG(QVariant, GlobalEnumerate::MCP23017_1),
                              Q_ARG(QVariant, this->_mcp23017_1->getIODIRreg())
                              );

    QMetaObject::invokeMethod(this->_settingViewer, "setMCP23017RegIODIR",
                              Q_ARG(QVariant, GlobalEnumerate::MCP23017_2),
                              Q_ARG(QVariant, this->_mcp23017_2->getIODIRreg())
                              );

    QMetaObject::invokeMethod(this->_settingViewer, "setMCP23017RegIODIR",
                              Q_ARG(QVariant, GlobalEnumerate::MCP23017_3),
                              Q_ARG(QVariant, this->_mcp23017_3->getIODIRreg())
                              );

    QMetaObject::invokeMethod(this->_settingViewer, "setMCP23017RegIODIR",
                              Q_ARG(QVariant, GlobalEnumerate::MCP23017_4),
                              Q_ARG(QVariant, this->_mcp23017_4->getIODIRreg())
                              );
...
void Setting::_saveSettings()
{
    ...
    this->_setting->setValue(GlobaleStaticValue::saveSmoothPlotTxt, this->_ads1115_1->smoothPlot());
    
    //MCP23017 register
    this->_setting->setValue(GlobaleStaticValue::saveMCP23017_1Txt, this->_mcp23017_1->getIODIRreg());
    this->_setting->setValue(GlobaleStaticValue::saveMCP23017_2Txt, this->_mcp23017_2->getIODIRreg());
    this->_setting->setValue(GlobaleStaticValue::saveMCP23017_3Txt, this->_mcp23017_3->getIODIRreg());
    this->_setting->setValue(GlobaleStaticValue::saveMCP23017_4Txt, this->_mcp23017_4->getIODIRreg());
...
void Setting::_loadSettings()
{
    ...
    QString smootPlot = groupeNameSetting + "/" + GlobaleStaticValue::saveSmoothPlotTxt;
    QString mcp23017_1 = groupeNameSetting + "/" + GlobaleStaticValue::saveMCP23017_1Txt;
    QString mcp23017_2 = groupeNameSetting + "/" + GlobaleStaticValue::saveMCP23017_2Txt;
    QString mcp23017_3 = groupeNameSetting + "/" + GlobaleStaticValue::saveMCP23017_3Txt;
    QString mcp23017_4 = groupeNameSetting + "/" + GlobaleStaticValue::saveMCP23017_4Txt;
...
//    this->_dataAnalyser->setChan5HighMaxValueInPuls(this->_setting->value(ADS115_5V_Chan1_ValueInPlus, 26000).toInt());
    ...
    //set MCP23017 register
    this->_mcp23017_1->setIODIRreg(this->_setting->value(mcp23017_1, 0x0000).toInt());
    this->_mcp23017_2->setIODIRreg(this->_setting->value(mcp23017_2, 0x0000).toInt());
    this->_mcp23017_3->setIODIRreg(this->_setting->value(mcp23017_3, 0x0000).toInt());
    this->_mcp23017_4->setIODIRreg(this->_setting->value(mcp23017_4, 0x0000).toInt());
