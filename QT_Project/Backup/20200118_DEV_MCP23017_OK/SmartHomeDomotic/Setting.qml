...
SettingForm
{
    ...
    signal sendSmoothPlotValueChanged(int SmoothValue)
    ...
    spinBoxSmoothPlot.onValueChanged:
    {
        sendSmoothPlotValueChanged(spinBoxSmoothPlot.value)
    }
...
//        console.log("setGraphicReccordTime ID: " + reccordTime)
    ...
    function setSmootPlotValue(SmootPlotValue)
    {
//        console.log("setGraphicReccordTime ID: " + reccordTime)

        spinBoxSmoothPlotValue = SmootPlotValue
    }

    function setMCP23017RegIODIR(MCP23017ID, value)
    {

        console.log("setMCP23017RegIODIR ID: " + MCP23017ID.toString(16) +
                    ", value : " + value.toString(2))

        switch(MCP23017ID)
        {
        case E_MCP23017ObjectID.MCP23017_1:
            mCP23017_1.setregIODIR(value)
            break;
        case E_MCP23017ObjectID.MCP23017_2:
            mCP23017_2.setregIODIR(value)
            break;
        case E_MCP23017ObjectID.MCP23017_3:
            mCP23017_3.setregIODIR(value)
            break;
        case E_MCP23017ObjectID.MCP23017_4:
            mCP23017_4.setregIODIR(value)
            break;
        default:
            break;
        }
    ...
    function setMCP23017ObjectName(ObjectID, objectName)
    {
        switch(ObjectID)
        {
        case E_MCP23017ObjectID.MCP23017_1:
            mCP23017_1.objectName = objectName;
            mCP23017_1.deviceID = E_HomePageObject.HOMEMCP23017_1;
            break;
        case E_MCP23017ObjectID.MCP23017_2:
            mCP23017_2.objectName = objectName;
            mCP23017_2.deviceID = E_HomePageObject.HOMEMCP23017_2;
            break;
        case E_MCP23017ObjectID.MCP23017_3:
            mCP23017_3.objectName = objectName;
            mCP23017_3.deviceID = E_HomePageObject.HOMEMCP23017_3;
            break;
        case E_MCP23017ObjectID.MCP23017_4:
            mCP23017_4.objectName = objectName;
            mCP23017_4.deviceID = E_HomePageObject.HOMEMCP23017_4;
            break;
        default:
            break;
        }
    ...
    function setMCP23017TitleName(ObjectID, titleName)
    {
        switch(ObjectID)
        {
        case E_MCP23017ObjectID.MCP23017_1:
            mCP23017_1.labelDeviceMCP23017Text = titleName;
            break;
        case E_MCP23017ObjectID.MCP23017_2:
            mCP23017_2.labelDeviceMCP23017Text = titleName;
            break;
        case E_MCP23017ObjectID.MCP23017_3:
            mCP23017_3.labelDeviceMCP23017Text = titleName;
            break;
        case E_MCP23017ObjectID.MCP23017_4:
            mCP23017_4.labelDeviceMCP23017Text = titleName;
            break;
        default:
            break;
        }
