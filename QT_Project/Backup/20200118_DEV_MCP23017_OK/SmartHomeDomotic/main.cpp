...
quint8 MCP23017_I2cSetup(quint8 i2CAddress, quint8 pinMode);
void _waitmDelay(int delayInMiliSeconde);
...
int main(int argc, char *argv[])
{
    ...
    qmlRegisterSingletonType( QUrl(QStringLiteral("qrc:/globalStyle.qml")), "io.qt.GlobalStyle", 1, 0, "GlobalStyle" );

    //init wiring pi GPIO setup
    wiringPiSetup();
    WiringPiGardian *wiringPiGardian = new WiringPiGardian();
//    wiringPiSetupGpio();
    ...
    //MCP23017
    QObject *qobjectMCP23017_1 = nullptr;
    QObject *qobjectMCP23017_2 = nullptr;
    QObject *qobjectMCP23017_3 = nullptr;
    QObject *qobjectMCP23017_4 = nullptr;
    ...
    if (!engine.rootObjects().isEmpty())
    {
        ...
        //Linked CPP object MCP23017 to QML MCP23017
        QMetaObject::invokeMethod(qobjectSettingViewer, "setMCP23017ObjectName",
                                  Q_ARG(QVariant, GlobalEnumerate::MCP23017_1),
                                  Q_ARG(QVariant, GlobaleStaticValue::ObjectNameMCP23017_1)
                                  );
        QMetaObject::invokeMethod(qobjectSettingViewer, "setMCP23017ObjectName",
                                  Q_ARG(QVariant, GlobalEnumerate::MCP23017_2),
                                  Q_ARG(QVariant, GlobaleStaticValue::ObjectNameMCP23017_2)
                                  );
        QMetaObject::invokeMethod(qobjectSettingViewer, "setMCP23017ObjectName",
                                  Q_ARG(QVariant, GlobalEnumerate::MCP23017_3),
                                  Q_ARG(QVariant, GlobaleStaticValue::ObjectNameMCP23017_3)
                                  );
        QMetaObject::invokeMethod(qobjectSettingViewer, "setMCP23017ObjectName",
                                  Q_ARG(QVariant, GlobalEnumerate::MCP23017_4),
                                  Q_ARG(QVariant, GlobaleStaticValue::ObjectNameMCP23017_4)
                                  );
        qobjectMCP23017_1 = engine.rootObjects().first()->findChild<QObject*>(GlobaleStaticValue::ObjectNameMCP23017_1);
        qobjectMCP23017_2 = engine.rootObjects().first()->findChild<QObject*>(GlobaleStaticValue::ObjectNameMCP23017_2);
        qobjectMCP23017_3 = engine.rootObjects().first()->findChild<QObject*>(GlobaleStaticValue::ObjectNameMCP23017_3);
        qobjectMCP23017_4 = engine.rootObjects().first()->findChild<QObject*>(GlobaleStaticValue::ObjectNameMCP23017_4);
...
//    readDataI2MCP23017(&MCP23017_2_fd, &MCP23017_3_fd);
    ...
    quint8 MCP23017_1_fd = MCP23017_I2cSetup(GlobalEnumerate::MCP23017_1, GlobalEnumerate::MCP23017_1_pinBase);
    quint8 MCP23017_2_fd = MCP23017_I2cSetup(GlobalEnumerate::MCP23017_2, GlobalEnumerate::MCP23017_2_pinBase);
    quint8 MCP23017_3_fd = MCP23017_I2cSetup(GlobalEnumerate::MCP23017_3, GlobalEnumerate::MCP23017_3_pinBase);
    quint8 MCP23017_4_fd = MCP23017_I2cSetup(GlobalEnumerate::MCP23017_4, GlobalEnumerate::MCP23017_4_pinBase);

    MCP2317item *MCP23017_1 = new MCP2317item(GlobalEnumerate::MCP23017_1,
                                              GlobalEnumerate::MCP23017_1_pinBase,
                                              MCP23017_1_fd,
                                              qobjectHomeViewer,
                                              qobjectMCP23017_1,
                                              wiringPiGardian);

    MCP2317item *MCP23017_2 = new MCP2317item(GlobalEnumerate::MCP23017_2,
                                              GlobalEnumerate::MCP23017_2_pinBase,
                                              MCP23017_2_fd,
                                              qobjectHomeViewer,
                                              qobjectMCP23017_2,
                                              wiringPiGardian);

    MCP2317item *MCP23017_3 = new MCP2317item(GlobalEnumerate::MCP23017_3,
                                              GlobalEnumerate::MCP23017_3_pinBase,
                                              MCP23017_3_fd,
                                              qobjectHomeViewer,
                                              qobjectMCP23017_3,
                                              wiringPiGardian);

    MCP2317item *MCP23017_4 = new MCP2317item(GlobalEnumerate::MCP23017_4,
                                              GlobalEnumerate::MCP23017_4_pinBase,
                                              MCP23017_4_fd,
                                              qobjectHomeViewer,
                                              qobjectMCP23017_4,
                                              wiringPiGardian);
    ...
    //Smooth plot curve for avg value
    QObject::connect(qobjectSettingViewer, SIGNAL(sendSmoothPlotValueChanged(int)),
                     setting, SLOT(receivedSmoothPlotValueChanged(int)));
    ...
    //From MCP23017_xxx.qml to Setting to configure the IODIR register to the hardware device
    QObject::connect(qobjectMCP23017_1, SIGNAL(sendIODIRregChanged(int, int)),
                     setting, SLOT(ReceivedIODIRregChanged(int, int)));

    QObject::connect(qobjectMCP23017_2, SIGNAL(sendIODIRregChanged(int, int)),
                     setting, SLOT(ReceivedIODIRregChanged(int, int)));

    QObject::connect(qobjectMCP23017_3, SIGNAL(sendIODIRregChanged(int, int)),
                     setting, SLOT(ReceivedIODIRregChanged(int, int)));

    QObject::connect(qobjectMCP23017_4, SIGNAL(sendIODIRregChanged(int, int)),
                     setting, SLOT(ReceivedIODIRregChanged(int, int)));

    //From MCP23017_xxx.qml to Setting to configure the GPIO register to the hardware device
    QObject::connect(qobjectMCP23017_1, SIGNAL(sendGPIOregChanged(int, int)),
                     setting, SLOT(ReceivedGPIOregChanged(int, int)));

    QObject::connect(qobjectMCP23017_2, SIGNAL(sendGPIOregChanged(int, int)),
                     setting, SLOT(ReceivedGPIOregChanged(int, int)));

    QObject::connect(qobjectMCP23017_3, SIGNAL(sendGPIOregChanged(int, int)),
                     setting, SLOT(ReceivedGPIOregChanged(int, int)));

    QObject::connect(qobjectMCP23017_4, SIGNAL(sendGPIOregChanged(int, int)),
                     setting, SLOT(ReceivedGPIOregChanged(int, int)));
...
//          !MCP23017_1->isRunning() && !MCP23017_2->isRunning() && !MCP23017_3->isRunning() && !MCP23017_4->isRunning());
...
//    mcp23017Setup (pinMode, i2CAddress) ;
