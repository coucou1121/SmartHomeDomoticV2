...
#define BACKGROUD_COLOR 70,70,70                    //deep dark Grey    #464646
#define BACKGROUD_COLOR_PUSHBUTTON_ON 220,220,220   //light Gray        #DCDCDC
#define BACKGROUD_COLOR_PUSHBUTTON_OFF 90,90,90     //drak Grey         #5A5A5A
#define BACKGROUD_COLOR_LABEL 125,125,125           //Gray              #7D7D7D
#define BACKGROUD_COLOR_FRAME 119,119,119           //Gray              #777777
#define BACKGROUD_COLOR_ERROR_FRAME 255,160,160     //soft Red          #FFA0A0
...
//    //Grid
    ...
    //push button
    static QColor _pushbutton_ON;
    static QColor _pushbutton_OFF;
