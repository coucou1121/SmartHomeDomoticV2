...
void DataAnalyser::_updateDataForTheHour(quint8 minuteToUpdate)
{
    ...
    static qint16 memoVolumeTotal = 0;
    ...
    quint16 volumeChan0 = 0;
    quint16 volumeChan1 = 0;
    quint16 volumeChan2 = 0;
    quint16 volumeChan3 = 0;
    quint16 volumeTotal = 0;
    quint16 VolumeTotalMin = 32000;
...
//            volumeConsoTotal += listeOfData[11].toInt();
        ...
        volumeChan0 = (quint16)qRound((double)volumeChan0/cpt);
        volumeChan1 = (quint16)qRound((double)volumeChan1/cpt);
        volumeChan2 = (quint16)qRound((double)volumeChan2/cpt);
        volumeChan3 = (quint16)qRound((double)volumeChan3/cpt);
...
void DataAnalyser::ReceivedreplotWithSavedData(int year, int month, int day)
{
    ...
    if (fileToAnalyse.open(QFile::ReadOnly))
    {
        while (!streamAnalyse.atEnd())
        {
            ...
            consoTotal += listeOfData[12].toShort();
