...
Rectangle
{
    ...
    height: 300
    color: "#353131"
    property alias radioButtonOilEcoText: radioButtonOilEco.text
    property alias radioButtonOilText: radioButtonOil.text
    property alias radioButtonWaterText: radioButtonWater.text
