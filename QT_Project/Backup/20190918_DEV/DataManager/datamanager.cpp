...
void DataManager::run()
{
    ...
    while(true)
    {
        ...
        if(inReadingProcess)
        {
            ...
            //wait until they read all value
            do
            {
                this->msleep(10);
            }
            ...
            this->_itdataFrameBuffer1->setDataFrameState(this->_BME280->dataFrame()->dataFrameState());

            //            qDebug() << Q_FUNC_INFO << "BME280 state: " << this->_itdataFrameBuffer1->dataFrameState()
            //                                    << "Pressure : " << this->_itdataFrameBuffer1->BME280_pressure();

            //set data frame for pressure compensation calculation
            this->_ADS1115_1->dataFrame()->setBME280_pressure(this->_itdataFrameBuffer1->BME280_pressure());
            this->_ADS1115_1->dataFrame()->setDataFrameState(this->_itdataFrameBuffer1->dataFrameState());
//            this->_ADS1115_1->setDataFrame(this->_itdataFrameBuffer1);

            //ask to read one data
            this->_ADS1115_1->setStartToReadOnData(true);

//            qDebug() << Q_FUNC_INFO <<
//                        "DataTemp temp 1: " << this->_itdataFrameBuffer1->BME280_temperature() <<
...
//                        ", state : " << this->_itdataFrameBuffer1->dataFrameState();
...
//            }
            ...
            while(this->_ADS1115_1->dataFrame()->dataFrameState() != 31);


            //copy the data from ADS1115 object
            ...
            this->_itdataFrameBuffer1->setDataFrameState(this->_ADS1115_1->dataFrame()->dataFrameState());
...
//            qDebug() << Q_FUNC_INFO <<
//                        "DataTemp temp 2: " << this->_itdataFrameBuffer1->BME280_temperature() <<
//                        ", hum " << this->_itdataFrameBuffer1->BME280_humidity() <<
//                        ", press : " << this->_itdataFrameBuffer1->BME280_pressure() <<
//                        ", chan 0: " << this->_itdataFrameBuffer1->ADS115_1_chan0() <<
//                        ", chan 1: " << this->_itdataFrameBuffer1->ADS115_1_chan1() <<
...
//                        ", state : " << this->_itdataFrameBuffer1->dataFrameState();
            ...
            this->_dataAnalyerObject->savePlotData(this->_itdataFrameBuffer1);
        ...
        {
//            qDebug() << Q_FUNC_INFO <<
//                        "DataTemp temp 3: " << this->_itdataFrameBuffer1->BME280_temperature() <<
//                        ", hum " << this->_itdataFrameBuffer1->BME280_humidity() <<
//                        ", press : " << this->_itdataFrameBuffer1->BME280_pressure() <<
//                        ", chan 0: " << this->_itdataFrameBuffer1->ADS115_1_chan0() <<
//                        ", chan 1: " << this->_itdataFrameBuffer1->ADS115_1_chan1() <<
