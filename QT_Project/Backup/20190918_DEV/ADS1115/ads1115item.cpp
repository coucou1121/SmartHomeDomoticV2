...
//        qDebug() << Q_FUNC_INFO << this->_deviceName << " state : " << dataframeState;

        //if all datas are recording correctly
        if(dataframeState == 31)
        {
            offsetPressure = (double)1000 - BME280_pressure;



            chan0 = chan0 + offsetPressure + _offsetPressurChan0;
            chan1 = chan1 + offsetPressure + _offsetPressurChan1;
            ...
            if(firstTimeRequest)
            {
                ...
                //                sendTankActualVolumeChanged(this->_tankIDchan2, qRound(chan2));
                //                sendTankActualVolumeChanged(this->_tankIDchan3, qRound(chan3));
            ...
            else
            {
                ...
                //                qDebug() << Q_FUNC_INFO
                //                         << "Chan0: " << chan0 << ", offset Chan0: " << offsetPressure
                //                         << "Chan1: " << chan1 << ", offset Chan1: " << offsetPressure
                //                         << ", BME280_pressure: " << BME280_pressure << "BME280 state: " << this->_dataFrame->dataFrameState();
                ...
                //                this->_insertTextAtHomePage(
                //                            GlobaleStaticValue::ADS1115_1Title
                //                            + " : Chan0: " + QString::number(chan0) + ", \toffset Chan0: " + QString::number(offsetPressure)
                //                            + "\tChan1: " + QString::number(chan1) + ", \toffset Chan1: " + QString::number(offsetPressure)
                //                            + "\tBME280_pressure: " + QString::number(BME280_pressure)
                //                            );
