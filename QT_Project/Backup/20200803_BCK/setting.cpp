...
//    this->initTankOffsetPressure(this->_Tank6->objectID(),this->_ads1115_2->offsetPressurChan1());
    ...
    this->initHomeViewObject(GlobalEnumerate::HOMEAMCP23017_1, _homeViewObject[GlobalEnumerate::HOMEAMCP23017_1]);
    this->initHomeViewObject(GlobalEnumerate::HOMEAMCP23017_2, _homeViewObject[GlobalEnumerate::HOMEAMCP23017_2]);
    this->initHomeViewObject(GlobalEnumerate::HOMEAMCP23017_3, _homeViewObject[GlobalEnumerate::HOMEAMCP23017_3]);
    this->initHomeViewObject(GlobalEnumerate::HOMEAMCP23017_4, _homeViewObject[GlobalEnumerate::HOMEAMCP23017_4]);
