...
#include "../SmartHomeDomotic/TimerThread.h"
...
QT_MOC_LITERAL(1, 12, 13), // "delayFinished"
QT_MOC_LITERAL(2, 26, 0) // ""

    },
    "timerthread\0delayFinished\0"
};
...
void timerthread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&timerthread::delayFinished)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void timerthread::delayFinished()
{
