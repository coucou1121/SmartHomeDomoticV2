...
#include "../SmartHomeDomotic/DataManager/datamanager.h"
...
QT_MOC_LITERAL(1, 12, 16), // "dataFrameWasSent"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 16), // "itProducerAdress"
QT_MOC_LITERAL(4, 47, 27), // "ReceivedreplotWithSavedData"
QT_MOC_LITERAL(5, 75, 4), // "year"
QT_MOC_LITERAL(6, 80, 5), // "month"
QT_MOC_LITERAL(7, 86, 3) // "day"

    },
    "DataManager\0dataFrameWasSent\0\0"
    "itProducerAdress\0ReceivedreplotWithSavedData\0"
    "year\0month\0day"
};
...
void DataManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->dataFrameWasSent((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DataManager::dataFrameWasSent)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void DataManager::dataFrameWasSent(int _t1)
{
