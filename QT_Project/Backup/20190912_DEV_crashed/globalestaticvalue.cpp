...
//trace name in pressure live plot
QString GlobaleStaticValue::pressureLiveTraceNameTXT = "Pressure";

//trace name in live room plot
QString GlobaleStaticValue::temparatureTraceNameTXT = "Temperature";
QString GlobaleStaticValue::humidityRoomTraceNameTXT = "Humidity";
QString GlobaleStaticValue::pressureRoomTraceNameTXT = "Pressure x 10";

//pressure coeficient ADS1115
double GlobaleStaticValue::pressureCoefWater = 0.22;
double GlobaleStaticValue::pressureCoefOil = 0.18;
