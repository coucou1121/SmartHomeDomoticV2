...
//        this->_ads1115_2->setChan0_used(isVisible);
        break;
    case GlobalEnumerate::TANK4 :
        this->_Tank4->setIsVisible(isVisible);
//        this->_ads1115_2->setChan1_used(isVisible);
        break;
...
void Setting::receivedOnCalibrationMode(const bool onCalibration)
{
    ...
    QMetaObject::invokeMethod(this->_statisticViewer, "setOnCalibration",
                              Q_ARG(QVariant, onCalibration)
                              );

    QMetaObject::invokeMethod(this->_tankViewer, "setOnCalibration",
                              Q_ARG(QVariant, onCalibration)
                              );
}
...
void Setting::initSetting()
{
    ...
    //init nb of trace in live pressure plot
    QMetaObject::invokeMethod(this->_statisticViewer, "setPressureTraceNomberInGraph",
                              Q_ARG(QVariant, 1)
                              );

    //init name of trace in live pressure plot
    QMetaObject::invokeMethod(this->_statisticViewer, "setPressureTraceTitleText",
                              Q_ARG(QVariant, GlobaleStaticValue::pressureLiveTraceNameTXT)
                              );
...
void Setting::saveTankSetting(Tank *tank)
{
    ...
    {
    case GlobalEnumerate::TANK1:
        this->_setting->setValue(GlobaleStaticValue::saveOffsetPressureTxt, this->_ads1115_1->offsetPressurChan0());
        break;
    case GlobalEnumerate::TANK2:
        this->_setting->setValue(GlobaleStaticValue::saveOffsetPressureTxt, this->_ads1115_1->offsetPressurChan1());
        break;
    case GlobalEnumerate::TANK3:
        this->_setting->setValue(GlobaleStaticValue::saveOffsetPressureTxt, this->_ads1115_1->offsetPressurChan2());
        break;
    case GlobalEnumerate::TANK4:
        this->_setting->setValue(GlobaleStaticValue::saveOffsetPressureTxt, this->_ads1115_1->offsetPressurChan3());
        break;
    case GlobalEnumerate::TANK5:
        this->_setting->setValue(GlobaleStaticValue::saveOffsetPressureTxt, this->_ads1115_2->offsetPressurChan0());
        break;
    case GlobalEnumerate::TANK6:
        this->_setting->setValue(GlobaleStaticValue::saveOffsetPressureTxt, this->_ads1115_2->offsetPressurChan1());
        break;
    default:
        break;
    }
...
void Setting::loadSettings()
{
    ...
    this->_ads1115_1->setOffsetChan0InPuls(this->_setting->value(ADS115_0V_Chan0_ValueInPlus, 0).toInt());
    this->_ads1115_1->setOffsetChan1InPuls(this->_setting->value(ADS115_0V_Chan1_ValueInPlus, 0).toInt());
    this->_ads1115_1->setChan0HighMaxValueInPuls(this->_setting->value(ADS115_5V_Chan0_ValueInPlus, 26000).toInt());
    this->_ads1115_1->setChan1HighMaxValueInPuls(this->_setting->value(ADS115_5V_Chan1_ValueInPlus, 26000).toInt());
