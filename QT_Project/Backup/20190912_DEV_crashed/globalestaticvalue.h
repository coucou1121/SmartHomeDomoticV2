...
public:
 ...
 //   static quint16 pressureCapteurRangeMaxInPlus;
    ...
    //pressure live plot trace name
    static QString pressureLiveTraceNameTXT;

    //pressure room plot trace name
    static QString temparatureTraceNameTXT;
    static QString humidityRoomTraceNameTXT;
    static QString pressureRoomTraceNameTXT;
