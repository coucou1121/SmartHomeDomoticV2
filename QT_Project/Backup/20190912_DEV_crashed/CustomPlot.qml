...
Item
{
    ...
    property string tracePressureName: ""
    ...
    function setupStyleTankTrace(nbTrace)
    {
        //        console.log(objectName + " setupStyleWeatherStation")
        customPlotItem.setupStyle(E_PlotStyle.PLOT_STYLE_TANK_TRACE, nbTrace)
        isReadyToReceiveData = true
    }
    ...
    function setupStyleAnalogTracePressure(nbTrace)
    {
        //        console.log(objectName + " setupStyleWeatherStation")
        customPlotItem.setupStyle(E_PlotStyle.PLOT_STYLE_ANANLOG_TRACE, nbTrace, E_PlotStyle.PLOT_STYLE_PRESSURE_TRACE)
        isReadyToReceiveData = true
    }
    ...
    function setupTraceName(tankObjectID, titleText)
    {
        ...
        customPlotItem.setupGraphTankLabel(tankObjectID, titleText)
        switch (tankObjectID)
        {
        case 1:
    ...
    function setupPressureTraceName(titleText)
    {
        customPlotItem.setupGraphLabel(titleText)
        tracePressureName = titleText
    }
