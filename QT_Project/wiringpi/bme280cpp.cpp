...
void BME280cpp::readCalibrationData(int fd, bme280_calib_data *data)
{
...
int32_t BME280cpp::getTemperatureCalibration(bme280_calib_data *cal, int32_t adc_T)
{
...
float BME280cpp::compensateTemperature(int32_t t_fine)
{
    float T  = (t_fine * 5 + 128) >> 8;
    return T/100;
}

float BME280cpp::compensatePressure(int32_t adc_P, bme280_calib_data *cal, int32_t t_fine)
{
    int64_t var1, var2, p;
...
float BME280cpp::compensateHumidity(int32_t adc_H, bme280_calib_data *cal, int32_t t_fine)
{
    int32_t v_x1_u32r;
...
void BME280cpp::getRawData(int fd, bme280_raw_data *raw)
{
...
float BME280cpp::getAltitude(float pressure)
{
